...
import './SimilarCategoryVideo.css'
import { Link } from 'react-router-dom'


function SimilarCategoryVideo() {
    return (
        <div className='px-5'>
            <div id="SimilarCategoryVideoControls" className="carousel slide" data-bs-interval="false">
                <div className="carousel-inner pt-5">
                <h4><Link to="/" style={{textDecoration:"none", color:"white"}}>More Like This</Link></h4>
                    <div className="carousel-item similar_category_zoom_on_hover active">
                        <div className="row">
                ...
                <button className="carousel-control-prev" type="button" data-bs-target="#SimilarCategoryVideoControls" data-bs-slide="prev" style={{ width: "50px", marginTop:"35vh" }}>
                    <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span className="visually-hidden">Previous</span>
                </button>
                <button className="carousel-control-next" type="button" data-bs-target="#SimilarCategoryVideoControls" data-bs-slide="next" style={{ width: "50px", marginTop:"35vh" }}>
...
export default SimilarCategoryVideo;
