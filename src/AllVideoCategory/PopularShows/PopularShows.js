...
function PopularShows() {
    return (
        <>
            <div id="PopularShowsControls" className="carousel slide" data-bs-interval="false">
            <div className="carousel-inner">
                    <p className='pt-3' style={{ fontSize: "28px" }}><b><Link to="/single_category" style={{ textDecoration: "none", color: "white" }}>Popular Shows</Link></b></p>
                ...
                <button className="carousel-control-prev" type="button" data-bs-target="#PopularShowsControls" data-bs-slide="prev" style={{ width: "50px", height: "100%" }}>
                    <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span className="visually-hidden">Previous</span>
                </button>
                <button className="carousel-control-next" type="button" data-bs-target="#PopularShowsControls" data-bs-slide="next" style={{ width: "50px", height: "100%" }}>
