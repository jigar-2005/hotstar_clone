...
function LatestAndTrending() {
    return (
        <>
            <Link to="/single_category" style={{ textDecoration: "none", color: "white" }}><p className='pt-3' style={{ fontSize: "28px" }}><b>Latest & Trending</b></p></Link>
            <div id="LatestAndTrendingControls" className="carousel slide" data-bs-ride="carousel">
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <div className="row">
                            ...
                            <div className="col carousel_item_2">
                                <Link to="/">
                            ...
                            <div className="col carousel_item_3">
                                <Link to="/">
                            ...
                            <div className="col carousel_item_4">
                                <Link to="/">
                            ...
                            <div className="col carousel_item_5">
                                <Link to="/">
                            ...
                            <div className="col carousel_item_6">
                                <Link to="/">
                            ...
                            <div className="col carousel_item_7">
                                <Link to="/">
                            ...
                            <div className="col carousel_item_8">
                                <Link to="/">
                ...
                <button className="carousel-control-prev" type="button" data-bs-target="#LatestAndTrendingControls" data-bs-slide="prev" style={{ width: "50px", height: "100%" }}>
                    <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span className="visually-hidden">Previous</span>
                </button>
                <button className="carousel-control-next" type="button" data-bs-target="#LatestAndTrendingControls" data-bs-slide="next" style={{ width: "50px", height: "100%" }}>
