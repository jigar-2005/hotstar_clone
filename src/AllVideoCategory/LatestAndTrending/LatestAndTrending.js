...
function LatestAndTrending() {
    return (
        <>
            <div id="LatestAndTrendingControls" className="carousel slide" data-bs-interval="false">
                <div className="carousel-inner">
                    <p className='pt-3' style={{ fontSize: "28px" }}><b><Link to="/single_category" style={{ textDecoration: "none", color: "white" }}>Latest & Trending</Link></b></p>
                            ...
                            <div className="col carousel_item_1 pb-4">
                                <Link to="/">
                                    <div class="video_thumbnail">
                                        ...
                                        <div className='w-100 px-2 video_description'>Image 1 TextImage 1 TextImage 1 TextImage 1 TextImage 1 TextImage 1 TextImage 1 TextImage 1 TextImage 1 TextImage 1 Text</div>
                                    </div>
                                    {/* <img className="d-block w-100 carousel_item" src="https://img1.hotstarext.com/image/upload/f_auto,t_web_vl_3x/sources/r1/cms/prod/8812/1148812-v-93639980824a" alt="#" style={{ height: "275px" }} /> */}
                                </Link>
                            </div>
