...
function MoviesRecommended() {
    return (
        <>
            <Link to="/single_category" style={{ textDecoration: "none", color: "white" }}><p className='pt-3' style={{ fontSize: "28px" }}><b>Movies Recommended For You</b></p></Link>
            <div id="MoviesRecommendedControls" className="carousel slide" data-bs-ride="carousel">
